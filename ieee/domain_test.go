...
// HTTP behaviour is covered in ieee_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "ieee" {
		t.Errorf("Identity.Binary = %q, want ieee", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ieee://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ieee", "about")
	if err != nil || got.String() != "ieee://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ieee://page/about", got.String(), err)
	}
}
