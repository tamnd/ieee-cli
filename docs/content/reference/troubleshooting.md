...
Most of these come down to network reality or how ieee serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ieee rate-limits like any public site. ieee already paces
...
Where a surface is gated, ieee reads a cookie or token you supply
...
`ieee`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ieee actually did
